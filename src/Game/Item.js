...
export class Item {
   ...
   * @param {boolean} itemConfig.isEnabled evaluated when opening the inventory, if false the item is not displayed
   * @param {boolean} itemConfig.isUsed evaluated when opening the inventory, if true the item is displayed as used
